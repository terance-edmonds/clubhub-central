        ...
        <div class="content-section">
            <form class="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-section-content">
                        <div class="multi-wrap">
                            <div class="input-wrap">
                                ...
                                <input value="<?= setValue('first_name') ?>" id="first_name" type="text"
                            ...
                            <div class="input-wrap">
                                ...
                                <input value="<?= setValue('last_name') ?>" id="last_name" type="text" name="last_name"
                        ...
                        <div class="input-wrap">
                            ...
                            <input disabled value="<?= setValue('email') ?>" id="email" type="email" name="email"
                        ...
                        <div class="input-wrap">
                            ...
                            <textarea id="description" name="description"
                                placeholder="Description"><?= setValue('description') ?></textarea>
                ...
                <div class="buttons-wrap">
                    <button type="submit" name="submit" value="update_profile" class="button contained">Save
                        Details</button>
                </div>
            </form>
            ...
            <form name="change_password" class="form" method="post">
                <div class="form-section">
                    ...
                    <div class="form-section-content">
                        <div class="input-wrap">
                            ...
                            <input value="<?= setValue('current_password') ?>" id="current_password" type="password"
                        ...
                        <div class="multi-wrap">
                            <div class="input-wrap">
                                ...
                                <input value="<?= setValue('new_password') ?>" id="new_password" type="password"
                            ...
                            <div class="input-wrap">
                                ...
                                <input value="<?= setValue('confirm_new_password') ?>" id="confirm_new_password"
                ...
                <div class="buttons-wrap">
                    <button type="submit" name="submit" value="change_password" class="button contained">Change
                        Password</button>
                </div>
            </form>
        </div>
