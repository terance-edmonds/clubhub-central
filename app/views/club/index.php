...
<div id="club" class="container container-sections side-padding">
    ...
    <section class="center-section">
        <div class="tabs">
            <a href="<?= ROOT ?>/club?id=<?php $club_id ?>" class="tab"
                data-active="<?php if ($tab == 'club-posts')
                    echo 'true'; ?>"><span class="text">Club Posts</span></a>
            <a href="<?= ROOT ?>/club?tab=events&id=<?php $club_id ?>" class="tab"
                data-active="<?php if ($tab == 'events')
                    echo 'true'; ?>"><span class="text">Events</span></a>
            <a href="<?= ROOT ?>/club?tab=gallery&id=<?php $club_id ?>" class="tab"
                data-active="<?php if ($tab == 'gallery')
