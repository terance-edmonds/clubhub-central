            ...
            <div class="content-section">
                <div class="action-buttons">
                    <a class="action-link" data-active="<?php if ($tab == 'posts')
                        echo 'true'; ?>"
                        href="<?= ROOT ?>/club/dashboard/logs?tab=posts"><button class="button">Posts</button></a>
                    <a class="action-link" data-active="<?php if ($tab == 'budgets')
                        echo 'true'; ?>"
                        href="<?= ROOT ?>/club/dashboard/logs?tab=budgets"><button class="button">Budgets</button></a>
                </div>
