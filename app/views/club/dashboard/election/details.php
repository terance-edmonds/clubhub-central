            ...
            <div class="actions-wrap">
                <div class="action-buttons">
                    <a class="action-link" data-active="<?php if ($tab == 'president')
                                                            echo 'true'; ?>" href="<?= ROOT ?>/club/dashboard/election/details?election_id=<?= $election_id ?>&tab=president"><button class="button">President</button></a>
                    <a class="action-link" data-active="<?php if ($tab == 'secretary')
                                                            echo 'true'; ?>" href="<?= ROOT ?>/club/dashboard/election/details?election_id=<?= $election_id ?>&tab=secretary"><button class="button">Secretary</button></a>
                    <a class="action-link" data-active="<?php if ($tab == 'treasurer')
                                                            echo 'true'; ?>" href="<?= ROOT ?>/club/dashboard/election/details?election_id=<?= $election_id ?>&tab=treasurer"><button class="button">Treasurer</button></a>
                </div>
            </div>
