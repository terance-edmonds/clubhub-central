        ...
        ?>
            ...
            <tr class="table-data table-align">
                <td class="checkbox-col">
                    <input onclick="onAddGroupMember(event, '<?= $val->id ?>', '<?= $val->user_id ?>', '<?= $val->first_name ?> <?= $val->last_name ?>')" data-value="<?= $val->id ?>" type="checkbox" name="user_select_checkbox" class="checkbox pointer-cursor" />
                </td>
                <td>
