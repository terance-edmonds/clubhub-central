...
<div id="event-dashboard-event-edit"
        ...
        <div class="content-section">
            <form class="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-section-content">
                        ...
                        <div class="multi-wrap">
                            <div class="input-wrap">
                                ...
                                <input set-min="<?= $start_datetime ?>"
                                    value="<?= setValue('start_datetime', '', 'datetime') ?>" id="start_datetime"
                            ...
                            <div class="input-wrap">
                                ...
                                <input set-min="<?= $start_datetime ?>"
                                    value="<?= setValue('end_datetime', '', 'datetime') ?>" id="end_datetime"
                ...
                <div class="buttons-wrap">
                    <button type="submit" name="submit" value="update_event" class="button contained">Save
                        Event</button>
                </div>
            </form>
        </div>
